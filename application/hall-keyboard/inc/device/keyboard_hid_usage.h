#ifndef KEYBOARD_HID_USAGE_H
#define KEYBOARD_HID_USAGE_H

#define Keyboard_Reserved 		  0	  // no event indicated
#define Keyboard_ERR_Roll 		  1	  // Keyboard error roll over 
#define Keyboard_POSTFail 		  2	  // Keyboard POST Fail
#define Keyboard_ERR_Unde 		  3	  // Keyboard error unde fined
...
// #define Keyboard_Modifier_Value	  0	  // 修饰键位掩码
#define Keyboard_LeftControl      224 // Left Ctrl 0xE0
#define Keyboard_LeftShift        225 // Left Shift 0xE1
#define Keyboard_LeftAlt          226 // Left Alt 0xE2
#define Keyboard_LeftWindows      227 // Left Windows(GUI) 0xE3
#define Keyboard_RightControl     228 // Right Ctrl 0xE4
#define Keyboard_RightShift       229 // Right Shift 0xE5
#define Keyboard_RightAlt         230 // Right Alt 0xE6
#define Keyboard_RightWindows     231 // Right Windows(GUI) 0xE7
#define Keyboard_FN1              254 // FN1

// 多媒体按键
#define CONSUMER_PLAYER_VALUE       {0x03,0x83,0x01}   // 播放器
#define CONSUMER_PREV_VALUE         {0x03,0xb6,0x00}   // 上一首
#define CONSUMER_NEXT_VALUE         {0x03,0xb5,0x00}   // 下一首
#define CONSUMER_STOP_VALUE         {0x03,0xcc,0x00}   // 停止
#define CONSUMER_PLAY_PAUSE_VALUE   {0x03,0xcd,0x00}   // 播放/暂停
#define CONSUMER_MUTE_VALUE         {0x03,0xe2,0x00}   // 静音
#define CONSUMER_VOLUME_UP_VALUE    {0x03,0xe9,0x00}   // 音量+
#define CONSUMER_VOLUME_DOWN_VALUE  {0x03,0xea,0x00}   // 音量-
#define CONSUMER_MAIL_VALUE         {0x03,0x8a,0x01}   // 邮件
#define CONSUMER_CALCULATOR_VALUE   {0x03,0x92,0x01}   // 计算器

// #define CONSUMER_COPY_VALUE         {0x01,0x01,0x06}   // 复制
// #define CONSUMER_PASTE_VALUE        {0x01,0x01,0x19}   // 粘贴
// #define CONSUMER_CUT_VALUE          {0x01,0x01,0x1b}   // 剪切
// #define CONSUMER_SELECT_ALL_VALUE   {0x01,0x01,0x04}   // 全选
// #define CONSUMER_NEW_VALUE          {0x01,0x01,0x11}   // 新建
// #define CONSUMER_SAVE_VALUE         {0x01,0x01,0x16}   // 保存
// #define CONSUMER_PRINT_VALUE        {0x01,0x01,0x13}   // 打印
// #define CONSUMER_OPEN_VALUE         {0x01,0x01,0x08}   // 打开
// #define CONSUMER_UNDO_VALUE         {0x01,0x01,0x1D}   // 撤销
#define CONSUMER_MY_COMPUTER_VALUE  {0x01,0x08,0x08}   // 我的电脑
#define CONSUMER_CLOSE_WINDOW_VALUE {0x01,0x04,0x3D}   // 关闭窗口
#define CONSUMER_SHOW_DESKTOP_VALUE {0x01,0x08,0x07}   // 显示桌面
#define CONSUMER_RUN_VALUE          {0x01,0x08,0x15}   // 运行
#define CONSUMER_MINIMIZE_VALUE     {0x01,0x08,0x51}   // 最小化
#define CONSUMER_MAXIMIZE_VALUE     {0x01,0x08,0x52}   // 最大化
